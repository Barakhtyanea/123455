...
import PlanetEditButton from "./PlanetEditButton";
import {addNewElement, editElement, removeElements} from '../Store/actions/Actions';
...
let EnhancedPlanetTable = ({ data, handleClickDeleteSelected, handleClickAddNewElement, handleClickEditElement}) => {
                  ...
                  return (
                    <TableRow key={row.key}>
                      ...
                      <TableCell align="right">
                        <PlanetEditButton data={row} changeElement={(changedObject) => handleClickEditElement(changedObject)} />
                      </TableCell>
                    </TableRow>
                  );
                })}
...
export default EnhancedPlanetTable = connect(mapStateToProps, mapDispatchToProps)(EnhancedPlanetTable);