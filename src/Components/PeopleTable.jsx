...
import PeopleEditButton from "./PeopleEditButton";
...
const headCells = [
  ...
  {
    id: 'eye_color', numeric: false, disablePadding: false, label: 'Eye color',
  },
  {
    id: 'hair_color', numeric: false, disablePadding: false, label: 'Hair color',
  },
];
  ...
  return (
    <div>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} deleteSelected={() => {handleClickDeleteSelected(selected); setSelected([]);}} newElement={() => handleClickAddNewElement()} />
        <TableContainer>
          <Table
                    ...
                    return (
                      <TableRow key={row.key}>
                        ...
                        <TableCell align="right">
                          <PeopleEditButton data={row} changeElement={(changedObject) => handleClickEditElement(changedObject)} />
                        </TableCell>
                      </TableRow>
                    );
                })}
...
export default EnhancedTable = withRouter(connect(mapStateToProps, mapDispatchToProps)(EnhancedTable));
